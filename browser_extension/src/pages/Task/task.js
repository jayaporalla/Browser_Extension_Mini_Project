...
export const Task = () => {
    ...
    useEffect(() => {
        ...
        if(Date.getDate !== Number(localStorage.getItem("date"))){
    ...
    const hanldeCompleteTaskChange = (event) => {
    ...
    return (
        <div className="task-container d-flex direction-column align-center relative">
            ...
            {name !== null && task === null ? (
                <Fragment>
                <span className="focus-question">What is your main foucs for today?</span>
                ...
                <div className="d-flex align-center gap">
                    ...
                    <input className="check cursor" type="checkbox" onChange={hanldeCompleteTaskChange} checked={isChecked}/>
                        {task}
                    </label>
