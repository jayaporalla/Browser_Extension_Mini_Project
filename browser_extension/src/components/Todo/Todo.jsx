    ...
    return (
        <div className="todo-container absolute">
            <div className="todo-input-container">
                <input className="todo-input" value={todo} onChange={handleTodoInputChange} onKeyPress={handleTodoEnterKey} placeholder="Add todo here..."/>
            </div>
                        ...
                        return (
                            <div key={_id} className="todo-items d-flex align-center">
                                <label className={`${isCompleted ? "strike-through" : ""} todo-label`}> 
                                    <input type="checkbox" onChange={() => handleTodoCheckChange(_id)} checked={isCompleted}/> {todo}</label>
